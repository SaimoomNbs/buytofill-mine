    ...
    <nav class="close">
        ...
        <!-- <div class="menu-items">
            <ul class="nav-links">
                ...
                <li id="openModal" aria-label="Login to access" data-cooltipz-dir="top" data-cooltipz-size="small">
                    <a href="#">
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <ul>
                <li>
                    <a href="" class="btn">
                        <!-- <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 12">
                ...
                <li aria-label="Cart" data-cooltipz-dir="bottom-right">
                ...
                <li aria-label="Login to access cart" data-cooltipz-dir="bottom-right">
        ...
        <div class="dash-content">
            ...
            <!-- <div class="category-holder">
                <div class="category-container">
                    <ul class="category-container-menu active" id="categoryMenu">
                        <li data-target="sub1">
                            Headphones<strong class="category-btn-counter">45</strong>
                        </li>
                        <li>Tablets</li>
                        <li>Computers</li>
                        <li>Mobile</li>
                        <li>Virtual Reality<strong class="category-btn-counter">35</strong></li>
                        <li>Accessories</li>
                        <li>Video Games</li>
                        <li>Wearables</li>
                        <li>Consoles</li>
                    ...
                    <ul class="category-container-menu" id="sub1">
                        <li class="category-container-menu-back-btn" data-back="categoryMenu">⬅ Back</li>
                        <li data-target="sub1_1">Gaming Laptop <strong class="category-btn-counter">57</strong></li>
                        <li>Bussiness Laptop</li>
                        <li>Personal Laptop</li>
                        <li>Laptop</li>
                    </ul>

                    <ul class="category-container-menu" id="sub1_1">
                        <li class="category-container-menu-back-btn" data-back="sub1">⬅ Back</li>
                        <li>Hp</li>
                        <li>Dell</li>
                        <li>Asus</li>
                        <li>Lenovo</li>
